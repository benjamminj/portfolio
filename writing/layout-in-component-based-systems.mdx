...
This component has two types of whitespace that it's handling:

1. The inner padding between the button border and the inner text.
2. The empty whitespace around the button border.
