						...
						<Card>
							<CardContent>
								<div className="space-y-4">
									<p>
										Base color tokens are the foundation of the color system. Each token represents
										a single shade of a given hue. The shade at the given token should <i>not</i>{' '}
										change when a theme is changes (i.e. light/dark mode).
									</p>
					...
					<section className="space-y-1">
						...
						<Card>
							<CardContent>
								<div className="space-y-4">
									<p>
										Alias color tokens are used to reference a base color token. However, they carry
										a <i>semantic</i> meaning. It is expected that an alias token's shade will vary
										from theme to theme.
									</p>
							...
							<CardContent>
								<div className="space-y-4">
									<p>
										...
										component. They should not be used outside of their component. They can
										reference either an alias or a base token, and the actual shade may vary from
										theme to theme.
									</p>

									<p>
										At this point in time no color tokens exist, but the idea is baked into the
										design system for completeness.
									</p>
								</div>
							</CardContent>
						</Card>
