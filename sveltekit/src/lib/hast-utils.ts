...
export type HtmlAstNodeLink = HtmlAstNodeBase<'link'> & { url: string; title: string | null }
export type HtmlAstNodeText = HtmlAstNodeBase<'text'> & { value: string; children: undefined }
...
export type HtmlAstNodeInlineCode = HtmlAstNodeBase<'inlineCode'> & { children: undefined }
